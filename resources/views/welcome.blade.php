...
<x-guest-layout>
    ...
    <div class="background-image">
        <div>
            ...
            <h2 class="translator-subtitle">De lenguas</h2>
        </div>
    </div>
    ...
    <div class="translator-container">
        <div class="translator-section">
            ...
            <select class="translator-select">
                ...
                <!-- Agrega aquí las opciones de lenguas indígenas -->
                <option>Lengua 1</option>
                <option>Lengua 2</option>
                <option>Lengua 3</option>
            </select>
